...
func (e *TestEvent) GetPayload() interface{} { // updated method name
	return e.Payload
}
...
func (suite *EventDispatcherTestSuite) SetupTest() {
	...
	suite.event2 = TestEvent{Name: "teste2", Payload: "teste2"}
}
...
func (suite *EventDispatcherTestSuite) TestEveEventDispatcher_Has() {
	// Event 1
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
	suite.Equal(1, len(suite.eventDispatcher.handlers[suite.event.GetName()]))
